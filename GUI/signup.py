...
# myentry1 = Entry(root).grid(row=2,column=2)

# l3 = Label(root,text="Password").grid(row = 4,column=1)

# myentry3 = Entry(root).grid(row=4,column=2)

# l4 = Label(root,text="Confirm Password").grid(row = 6,column=1)

# myentry4 = Entry(root).grid(row=6,column=2)

# submit = Button(root,text="Submit",command=check).grid(row=7,column=2) #!create a submit button
# root.mainloop()
